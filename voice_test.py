...
LOCAL_MODEL = str(Path.home() / "models" / "gpt2-medium.Q4_K_M.gguf")
...
def main():
    ...
    generated, elapsed, tokens = generate_response_local_llama(transcribed, n_predict=128, threads=4, temperature=0.4)
